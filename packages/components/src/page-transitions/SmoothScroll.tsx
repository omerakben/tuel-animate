...
export function SmoothScroll({
  ...
  useGsapContext(
    ...
    `;
      ...
      const updateScroll = () => {
        ...
        if (smooth) {
          ...
          scrollRef.current.current += scrollRef.current.velocity * lerp;
        } else {
      ...
      const handleTouchStart = (e: TouchEvent) => {
        ...
        touchStart = orientation === 'vertical' ? e.touches[0].clientY : e.touches[0].clientX;
      };
    ...
    [enabled, lerp, duration, orientation, smooth, smoothTouch, touchMultiplier, autoRaf]
  );
